...
import {DASHBOARD_PAGE_CLASS, SegmentedTabs, SPLIT_PANEL_TRANSITION_STYLE} from '../../shared/ui';
import {LAB_MANAGER_TAB_LABELS} from '../../features/lab/constants/labManagerTabLabels';
    ...
    return (
        <div className={DASHBOARD_PAGE_CLASS}>
            ...
            <div className="row g-4">
                <div className={selectedExam ? 'col-md-8' : 'col-md-12'} style={SPLIT_PANEL_TRANSITION_STYLE}>
                    <SegmentedTabs
                        tabs={STATUS_TABS}
                        activeTab={activeTab}
